...
git_url=https://github.com/yevgen4989/php.git
...
# SSH
echo -n "Testing ssh... "
docker_exec php touch /home/super/.ssh/known_hosts
docker_exec php ssh super@sshd cat /home/super/.ssh/authorized_keys | grep -q admin@example.com
echo "OK"
